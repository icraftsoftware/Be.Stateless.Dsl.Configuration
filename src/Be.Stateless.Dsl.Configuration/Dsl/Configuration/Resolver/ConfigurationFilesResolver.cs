...
namespace Be.Stateless.Dsl.Configuration.Resolver
{
	public sealed class ConfigurationFilesResolver
	{
		...
		{
			_resolverStrategies = resolverStrategies?.ToArray() ?? Array.Empty<IConfigurationFilesResolverStrategy>();
		}
		...
		private readonly IEnumerable<IConfigurationFilesResolverStrategy> _resolverStrategies;
	}
}
