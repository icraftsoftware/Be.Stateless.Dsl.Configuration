	...
	public static class ConfigurationCommandFactory
	{
		...
		private static ElementInsertionCommand CreateElementInsertionCommand(XPathNavigator navigator)
		{
			return new(
				...
				new(navigator.NamespaceURI, navigator.LocalName, navigator.GetAttributeUpdates(), navigator.BuildCurrentNodeRelativePath()));
		}
		...
		private static ElementUpsertionCommand CreateElementUpsertionCommand(XPathNavigator navigator)
		{
			...
			return new(parentNavigator.BuildAbsolutePath(), CreateElementInsertionCommand(navigator), CreateElementUpdateCommand(navigator));
		}
	}
}
